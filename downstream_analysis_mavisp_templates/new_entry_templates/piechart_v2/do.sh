...
python piechart_v2.py -i $csv -d  clinvar_interpretation_internal_dictionary.txt -o pie.pdf -cct germline
python piechart_v2.py -i $csv -d clinvar_interpretation_internal_dictionary.txt  -o pie.png -cct germline
