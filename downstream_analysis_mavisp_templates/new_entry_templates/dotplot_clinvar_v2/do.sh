...
python dot_plot_v2.py -i $csv -x  50  -pltD -pltP -pltR -pltC benign likely_benign pathogenic likely_pathogenic -vep none -cct germline -v dictionary.csv -o dot_plot_germline
...
python dot_plot_v2.py -i $csv -x  50  -pltD -pltP -pltR -pltC benign likely_benign oncogenic likely_oncogenic -vep none -cct oncogenicity -v oncodict.csv -o dot_plot_oncogenicity 
...
python dot_plot_v2.py -i $csv -x  50  -pltD -pltP -pltR -pltC benign potential strong -vep none -cct clinical_impact -v clinicaldict.csv -o dot_plot_clinical_impact
