...
python dot_plot_v2.py -i $csv -x  50  -pltD -pltR -pltC conflicting uncertain -vep -lgof -cct germline -v dictionary.csv -o dot_plot_germline
...
python dot_plot_v2.py -i $csv -x  50  -pltD -pltR -pltC conflicting uncertain -vep -lgof -cct oncogenicity -v oncodict.csv -o dot_plot_oncogenicity
...
python dot_plot_v2.py -i $csv -x  50  -pltD -pltR -pltC conflicting unknown -vep -lgof -cct clinical_impact -v clinicaldict.csv -o dot_plot_clinical_impact
